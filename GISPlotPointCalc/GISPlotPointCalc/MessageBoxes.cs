...
namespace GISPlotPointCalc
{
    ...
    class MessageBoxes
    {
        ...
        {
            MessageBox.Show(Content, "Congratulations!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            return "OK";
        }
        ...
        {
            MessageBox.Show("Operation was canceled by user.", "Oops!", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
        }
        ...
        {
            MessageBox.Show("折线段、多边形绘画与计算程序，由Rikakoist编写。", "LOL!");
        }
    }
}
